...
const Newsletter = () => {
  return (
    <div className='bg-transparent flex items-center justify-center mt-4'>
        <div className='bg-white lg:w-[60%] w-full h-auto flex items-center justify-center py-2 px-3 lg:py-7 lg:px-10'>
            <div className='rounded-lg bg-blue-50 w-[95%] flex flex-row p-[5%] lg:p-[5%] relative'>
                <div className='flex items-start justify-between w-[90%] lg:w-[65%] z-20 flex-col gap-1.5'>
                    ...
                    <div className='flex flex-row items-center w-[90%] justify-between gap-1'>
                ...
                <div className='flex items-center w-[60%] h-full lg:w-[30%] opacity-30 z-10 absolute top-0 right-0 bottom-0'>
                    <img src={aside} alt="/" className='w-full h-full object-cover' />
                </div>
            </div>
        </div>
    </div>
